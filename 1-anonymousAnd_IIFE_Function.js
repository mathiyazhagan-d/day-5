...
console.log(`A.  odd number in anonymous function : ${odd([1,2,3,4,5,6,7,8])}`);
...
(function(str) {
    ...
    console.log(`b. title caps in a string array IIFE function "${str.join(" ")}"`)
...
prim([ 3,5,1,2,4,8,12,14,15,18,19,23,25,37,38,42,45,46,49,58]);
...
for(let v=0;v < arr.length ;v++)     
 ...
 console.log(`d.the prime numbers in an array using IIFE  function ${primeNo}`)
})
...
let arr = function (array){
    ...
    //anonymous
    console.log("F.median of two sorted arrays of the same size anonymous and IIFE")
let m,n
